...
ggsave("AD_Rhizosphere_EMFOnly_ObservedSpecies_Rarefied_byMPB.pdf", AD_Rhizosphere_ObservedSpecies_Rarefied, width = 2, height = 5, units = "in")
...
ggsave("AD_Rhizosphere_EMFOnly_Shannons_Rarefied_byMPB.pdf", AD_Rhizosphere_Shannons_Rarefied, width = 2, height = 5, units = "in")
...
ggsave("alphadiversity_boxplots_Rhizosphere_EMFOnly_rarefied_tests_byMPB.pdf", final_plot, width = 14, height = 5, units = "in")
