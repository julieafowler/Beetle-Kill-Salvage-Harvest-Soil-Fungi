...
mod <- betadisper(mgd_ge5K_relabund.bray, sampledata$Salvage_Harvest_Status, bias.adjust = TRUE)
plot(mod)
...
ggsave("NMDS_Rhizosphere_Rarefied_BetaDispersion_SH.pdf", betadispersion_boxplot, width = 2, height = 5, units = "in")
...
fungal_guild_df$Salvage_Harvest_Status <- factor(fungal_guild_df$Salvage_Harvest_Status, levels = c("Non_Salvage_Harvested", "Salvage_Harvested")) 
...
#### EMF RA by Salvage Harvest Status ####
...
df$Salvage_Harvest_Status = factor(df$Salvage_Harvest_Status, levels = c("Non_Salvage_Harvested", "Salvage_Harvested"))
treatment_levels_SH <- c("Non_Salvage_Harvested", "Salvage_Harvested")
comparisons <- combn(treatment_levels_SH, 2, simplify = FALSE)

EMF_RA_Greenhouse_bySH <- ggplot(fungal_guild_df, aes(x = Salvage_Harvest_Status, y = EMF_RA)) +
  ...
  labs(title = "Rhizosphere EMF RA by Salvage Harvest Status",
       y = "EMF RA (%)") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(angle =  45, hjust = 1)) +
  # stat_compare_means(
...
EMF_RA_Greenhouse_bySH

ggsave("Greenhouse_EMF_RA_bySH.pdf", EMF_RA_Greenhouse_bySH, width = 2, height = 5, units = "in")

EMF_RA_Greenhouse_bySH <- EMF_RA_Greenhouse_bySH + stat_compare_means(
  comparisons = comparisons,
  method = "wilcox.test",  # Non-parametric pairwise comparison
  p.adjust.method = "BH",
  label = "p.signif",
...
ggsave("Greenhouse_EMF_RA_bySH_wtests.pdf", EMF_RA_Greenhouse_bySH, width = 2, height = 5, units = "in")
...
#### Plant Pathogen RA by Salvage Harvest Status ####
...
PlantPathogen_RA_Greenhouse_bySH <- ggplot(fungal_guild_df, aes(x = Salvage_Harvest_Status, y = PlantPathogen_RA)) +
  geom_boxplot(aes(fill = Salvage_Harvest_Status), outlier.shape = NA, alpha = 0.7) +
  geom_jitter(aes(fill = Salvage_Harvest_Status), position = position_jitter(width = 0.2), size = 1.5, alpha = 0.8, shape = 21, color = "black") +
  labs(title = "Rhizosphere PlantPathogen RA by Salvage Harvest Status",
       y = "PlantPathogen RA (%)") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(angle =  45, hjust = 1)) +
  # stat_compare_means(
...
PlantPathogen_RA_Greenhouse_bySH

ggsave("Greenhouse_PlantPathogen_RA_bySH.pdf", PlantPathogen_RA_Greenhouse_bySH, width = 2, height = 5, units = "in")

PlantPathogen_RA_Greenhouse_bySH <- PlantPathogen_RA_Greenhouse_bySH + stat_compare_means(
  comparisons = comparisons,
  method = "wilcox.test",  # Non-parametric pairwise comparison
  p.adjust.method = "BH",
  label = "p.signif",
...
ggsave("Greenhouse_PlantPathogen_RA_bySH_wtests.pdf", PlantPathogen_RA_Greenhouse_bySH, width = 2, height = 5, units = "in")
...
#### Fungal Parasite RA by Salvage Harvest Status ####
...
FungalParasite_RA_Greenhouse_bySH <- ggplot(fungal_guild_df, aes(x = Salvage_Harvest_Status, y = FungalParasite_RA)) +
  geom_boxplot(aes(fill = Salvage_Harvest_Status), outlier.shape = NA, alpha = 0.7) +
  geom_jitter(aes(fill = Salvage_Harvest_Status), position = position_jitter(width = 0.2), size = 1.5, alpha = 0.8, shape = 21, color = "black") +
  labs(title = "Rhizosphere FungalParasite RA by Salvage Harvest Status",
       y = "FungalParasite RA (%)") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(angle =  45, hjust = 1)) +
  # stat_compare_means(
...
FungalParasite_RA_Greenhouse_bySH

ggsave("Greenhouse_FungalParasite_RA_bySH.pdf", FungalParasite_RA_Greenhouse_bySH, width = 2, height = 5, units = "in")

FungalParasite_RA_Greenhouse_bySH <- FungalParasite_RA_Greenhouse_bySH + stat_compare_means(
  comparisons = comparisons,
  method = "wilcox.test",  # Non-parametric pairwise comparison
  p.adjust.method = "BH",
  label = "p.signif",
...
ggsave("Greenhouse_FungalParasite_RA_bySH_wtests.pdf", FungalParasite_RA_Greenhouse_bySH, width = 2, height = 5, units = "in")
...
treatment_levels <- c("Non_Salvage_Harvested", "Salvage_Harvested")
comparisons <- combn(treatment_levels, 2, simplify = FALSE)

AD_Rhizosphere_ObservedSpecies_Rarefied <- ggplot(alpha_div, aes(x = Salvage_Harvest_Status, y = Observed)) +
  geom_boxplot(aes(fill = Salvage_Harvest_Status), outlier.shape = NA, alpha = 0.7) +
  geom_jitter(aes(fill = Salvage_Harvest_Status), position = position_jitter(width = 0.2), size = 1.5, alpha = 0.8, shape = 21, color = "black") +
  labs(title = "Rhizosphere Observed Species by Salvage Harvest Status",
       y = "Observed Species") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  stat_compare_means(
...
ggsave("AD_Rhizosphere_ObservedSpecies_Rarefied_bySH_wtests.pdf", AD_Rhizosphere_ObservedSpecies_Rarefied, width = 2, height = 5, units = "in")
...
AD_Rhizosphere_Shannons_Rarefied <- ggplot(alpha_div, aes(x = Salvage_Harvest_Status, y = Shannon)) +
  geom_boxplot(aes(fill = Salvage_Harvest_Status), outlier.shape = NA, alpha = 0.7) +
  geom_jitter(aes(fill = Salvage_Harvest_Status), position = position_jitter(width = 0.2), size = 1.5, alpha = 0.8, shape = 21, color = "black") +
  labs(title = "Rhizosphere Shannon Diversity by Salvage Harvest Status",
       y = "Shannon Index") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  stat_compare_means(
...
ggsave("AD_Rhizosphere_Shannons_Rarefied_bySH_wtests.pdf", AD_Rhizosphere_Shannons_Rarefied, width = 2, height = 5, units = "in")
...
## For groups with only 2 factors (Non_Salvage_Harvested vs. Salvage_Harvested)
...
ggsave("NMDS_RootTips_Rarefied_BetaDispersion_SH.pdf", betadispersion_boxplot, width = 2, height = 5, units = "in")
...
EMF_RA_Greenhouse_bySH <- ggplot(fungal_guild_df, aes(x = Salvage_Harvest_Status, y = EMF_RA)) +
  geom_boxplot(aes(fill = Salvage_Harvest_Status), outlier.shape = NA, alpha = 0.7) +
  geom_jitter(aes(fill = Salvage_Harvest_Status), position = position_jitter(width = 0.2), size = 1.5, alpha = 0.8, shape = 21, color = "black") +
  labs(title = "RootTips EMF RA by Salvage Harvest Status",
       y = "EMF RA (%)") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(angle =  45, hjust = 1)) +
  # stat_compare_means(
...
PlantPathogen_RA_Greenhouse_bySH <- ggplot(fungal_guild_df, aes(x = Salvage_Harvest_Status, y = PlantPathogen_RA)) +
  geom_boxplot(aes(fill = Salvage_Harvest_Status), outlier.shape = NA, alpha = 0.7) +
  geom_jitter(aes(fill = Salvage_Harvest_Status), position = position_jitter(width = 0.2), size = 1.5, alpha = 0.8, shape = 21, color = "black") +
  labs(title = "RootTips PlantPathogen RA by Salvage Harvest Status",
       y = "PlantPathogen RA (%)") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(angle =  45, hjust = 1)) +
  # stat_compare_means(
...
FungalParasite_RA_Greenhouse_bySH <- ggplot(fungal_guild_df, aes(x = Salvage_Harvest_Status, y = FungalParasite_RA)) +
  geom_boxplot(aes(fill = Salvage_Harvest_Status), outlier.shape = NA, alpha = 0.7) +
  geom_jitter(aes(fill = Salvage_Harvest_Status), position = position_jitter(width = 0.2), size = 1.5, alpha = 0.8, shape = 21, color = "black") +
  labs(title = "RootTips FungalParasite RA by Salvage Harvest Status",
       y = "FungalParasite RA (%)") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(angle =  45, hjust = 1)) +
  # stat_compare_means(
...
AD_RootTips_ObservedSpecies_Rarefied <- ggplot(alpha_div, aes(x = Salvage_Harvest_Status, y = Observed)) +
  geom_boxplot(aes(fill = Salvage_Harvest_Status), outlier.shape = NA, alpha = 0.7) +
  geom_jitter(aes(fill = Salvage_Harvest_Status), position = position_jitter(width = 0.2), size = 1.5, alpha = 0.8, shape = 21, color = "black") +
  labs(title = "RootTips Observed Species by Salvage Harvest Status",
       y = "Observed Species") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  stat_compare_means(
...
ggsave("AD_RootTips_ObservedSpecies_Rarefied_bySH_wtests.pdf", AD_RootTips_ObservedSpecies_Rarefied, width = 2, height = 5, units = "in")
...
AD_RootTips_Shannons_Rarefied <- ggplot(alpha_div, aes(x = Salvage_Harvest_Status, y = Shannon)) +
  geom_boxplot(aes(fill = Salvage_Harvest_Status), outlier.shape = NA, alpha = 0.7) +
  geom_jitter(aes(fill = Salvage_Harvest_Status), position = position_jitter(width = 0.2), size = 1.5, alpha = 0.8, shape = 21, color = "black") +
  labs(title = "RootTips Shannon Diversity by Salvage Harvest Status",
       y = "Shannon Index") +
  theme_minimal(base_size = 12) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  stat_compare_means(
...
ggsave("AD_RootTips_Shannons_Rarefied_bySH_wtests.pdf", AD_RootTips_Shannons_Rarefied, width = 2, height = 5, units = "in")
