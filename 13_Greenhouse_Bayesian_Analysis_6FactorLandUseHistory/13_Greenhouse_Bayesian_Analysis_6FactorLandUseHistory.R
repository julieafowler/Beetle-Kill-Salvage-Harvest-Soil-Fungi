...
## This script uses LandUseHistory (6 variables) as the primary treatment in the models; there is another script that uses salvage harvest status
...
# NOTE: Salvage_Harvest_Status is perfectly nested within Treatment_LandUseHistory
#       (each LandUseHistory level maps to exactly one Salvage_Harvest_Status)
...
build_outcome_formulas <- function(include_soil_pcs = TRUE, n_soil_pcs = 3) {
  ...
  # NOTE: Salvage_Harvest_Status excluded because it's perfectly nested within Treatment_LandUseHistory
...
#    - Salvage_Harvest_Status excluded (perfectly nested within Treatment)
#    - Discuss this limitation in your methods/discussion
#
# 3. Variables to Exclude:
#    - Salvage_Harvest_Status: Perfectly nested within Treatment_LandUseHistory
